...
UPDATE Customers SET ContactName = 'Alfred Schmit'
WHERE CustomerID = 1;

-- 92번 고객의 고객명, 계약자명, 주소, 도시, 우편번호, 국가 수정하는 쿼리 작성/실행
SELECT * FROM Customers WHERE CustomerID = 92 OR CustomerID = 93;
UPDATE Customers
...
-- 93번 고객의 고객명, 계약자명, 주소, 도시, 우편번호, 국가 수정하는 쿼리 작성/실행
UPDATE Customers
