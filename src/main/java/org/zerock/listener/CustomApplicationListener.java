...
public class CustomApplicationListener implements ServletContextListener {
    ...
    public void contextInitialized(ServletContextEvent sce)  { 
    	...
    	// https://study-2022-08-02-343566579.s3.ap-northeast-2.amazonaws.com/prj1/board
    	ServletContext application = sce.getServletContext();
    	application.setAttribute("imgUrl", "https://study-2022-08-02-343566579.s3.ap-northeast-2.amazonaws.com/prj1/board");
